        ...
        <div class="card">
            <div class="card-body">
                ...
                <p> <i class="fas fa-shipping-fast"></i>Students should register through online mode only. Please check
                    that you are registering via sfoly.com or Razorpay only.</abbr>.
                </p>
                <br />
                ...
                <p><i class="fas fa-money-check-alt"></i><b>REGISTRATION FEE:</b> A charge of Rs 99 towards the cost of
                    the
                    examination is payable by each participating student. Further, students can register for any two
                    or all three Olympiads to get a better deal.</p>
                <br />
                <p><i class="fas fa-award"></i><b>AWARDS:</b> For the academic year 2020-21, Springfield Olympiads will
