...
<script src="/__/firebase/init.js"></script>
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation" style="top: 0px;">
          <div class="container">
  ...
  <div class="col-lg-6 col-xs-12">
    <div class="card">
      <div class="card-body" style="height:260px;">
          <h3 class ="card-title"style="text-align: center;">Grads Olympiad</h3><br>
...
<div class="col-lg-6 col-xs-12 ">
  ...
  <div class="col-lg-6 col-xs-12" id="finance-card">
    <div class="card">
      <div class="card-body" style="height:260px;">
          <h3 class ="card-title"style="text-align: center;">Finance Olympiad</h3><br>
          <p style="text-align: center;">The Finance Olympiad is a special curated Olympiad, made with a purpose to inculcate the habit and increase the knowledge of personal finances in a fun way. This is an online multiple-choice question-based Olympiad in which graduates and undergraduates can participate.</p><br>
          <div style="margin-left:165px">
          <a class="btn btn-info btn-flex" href="finance.html" style="margin:0px auto;color:black;" >Know More</a>
          </div>
      </div>
    </div> 
  </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12" style="margin-top: -5px;">
                         <div class="about-info">
                              ...
                              <p>We, at Springfield Olympiads, provide one of the best Olympiad solutions for students and working professionals and school children.</p>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <form id="contact-form"  action="" method="post">
                              ...
                              <h5 class="result" style="color:white;">Thanks For Contacting Us, we'll be in touch.</h5>
                              <h5 class="Error" style="color:red;">Something Happened! Try Again!</h5>
                              <h4 class="InvalidEmail" style="color:white;">Enter Valid Email Address</h4>
                              <div class="col-md-12 col-sm-12">
                                   <input id="name" type="text" class="form-control" placeholder="Enter full name" name="name" required="">
                              ...
                              <div class="col-md-4 col-sm-12">
                                   <input id="button1" type="submit" class="form-control" name="contact" value="contact">
                              </div>
