...
<center><table id="customers">
    <tr>
      <th style="text-align: center; font-size: 25px;">Rank</th>
      <th style="text-align: center; font-size: 25px;">Name</th>
      <th style="text-align: center; font-size: 25px;">Reward</th>
    </tr>
    <tr>
      <td>1st</td>
      <td>Simran Kaur</td>
  ...
  <h3><center> State Winners </center></h3><br>

<center><table id="customers" style="overflow-x:auto;">
    <tr>
    ...
    <tr>
      <td>Dadar and Nagar Haveli and Daman and Diu</td>
      <td>1</td>
      <td>Riya Mehta</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Kerala</td>
      <td>1</td>
      <td>Karthika G Kumar</td>
    </tr>
    <tr>
      <td></td>
      <td>2</td>
      <td>Ben Thomas Binu</td>
    </tr>
    <tr>
      <td></td>
      <td>3</td>
      <td>Neeraj Krishnan</td>
    </tr>
    <tr class="blank_row">
    <td colspan="3"></td>
</tr>
    ...
    <tr>
      <td></td>
      <td>3</td>
      <td>Rahul Choudhury</td>
    </tr>
  </table></center><br><br><br><br>

  <p style="font-size:20px;"> * Only top 10 percentile participants have been used to determine state ranks. Also, less then 3 state winners means that there were either less participants or were not in top 10 percentile.</p>
